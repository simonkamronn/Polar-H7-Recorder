...
public class BleDevicesAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = inflater.inflate(dk.compute.dtu.hrv.R.layout.listitem_device, null);
            viewHolder = new ViewHolder();
            viewHolder.deviceAddress = (TextView) view.findViewById(dk.compute.dtu.hrv.R.id.device_address);
            viewHolder.deviceName = (TextView) view.findViewById(dk.compute.dtu.hrv.R.id.device_name);
            viewHolder.deviceRssi = (TextView) view.findViewById(dk.compute.dtu.hrv.R.id.device_rssi);
        ...
        if (deviceName != null && deviceName.length() > 0)
            ...
            viewHolder.deviceName.setText(dk.compute.dtu.hrv.R.string.unknown_device);
