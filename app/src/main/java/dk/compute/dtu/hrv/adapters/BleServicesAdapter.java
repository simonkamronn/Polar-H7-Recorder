package dk.compute.dtu.hrv.adapters;
...
import dk.compute.dtu.hrv.info.BleInfoService;
import dk.compute.dtu.hrv.info.BleInfoServices;
...
public class BleServicesAdapter extends BaseExpandableListAdapter {
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(dk.compute.dtu.hrv.R.layout.listitem_service, parent,
					false);
			holder.name = (TextView) convertView.findViewById(dk.compute.dtu.hrv.R.id.name);
			holder.uuid = (TextView) convertView.findViewById(dk.compute.dtu.hrv.R.id.uuid);
			holder.demo = convertView.findViewById(dk.compute.dtu.hrv.R.id.demo);
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(dk.compute.dtu.hrv.R.layout.listitem_characteristic,
					parent, false);
			holder.name = (TextView) convertView.findViewById(dk.compute.dtu.hrv.R.id.name);
			holder.uuid = (TextView) convertView.findViewById(dk.compute.dtu.hrv.R.id.uuid);
			holder.modes = (TextView) convertView.findViewById(dk.compute.dtu.hrv.R.id.modes);
			holder.seek = (SeekBar) convertView.findViewById(dk.compute.dtu.hrv.R.id.seek);
			holder.seek
