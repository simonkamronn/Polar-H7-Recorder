package dk.compute.dtu.hrv.demo;
...
public class DemoHeartRateSensorActivity extends DemoSensorActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(dk.compute.dtu.hrv.R.layout.demo_opengl);
		view = (GLSurfaceView) findViewById(dk.compute.dtu.hrv.R.id.gl);

		getActionBar().setTitle(dk.compute.dtu.hrv.R.string.title_demo_heartrate);

		viewText = (TextView) findViewById(dk.compute.dtu.hrv.R.id.text);
	...
	public class PolygonRenderer extends AbstractRenderer {
		...
		private int previousInterval = 0;
